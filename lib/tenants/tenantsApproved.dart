...
class tenantsApproved extends StatefulWidget {
  const tenantsApproved({super.key});

  @override
  State<tenantsApproved> createState() => _tenantsApproved();
}

// ignore: camel_case_types
class _tenantsApproved extends State<tenantsApproved> {
  var IDnum;
  String status = "";
